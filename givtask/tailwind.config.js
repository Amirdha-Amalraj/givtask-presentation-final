...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        'card': '0 1px 3px 0 rgba(0,0,0,.05), 0 4px 24px 0 rgba(11,31,58,.06)',
        'card-hover': '0 4px 12px 0 rgba(0,0,0,.08), 0 16px 48px 0 rgba(11,31,58,.12)',
        'glow-blue': '0 0 40px rgba(37,99,235,0.25)',
        'glow-purple': '0 0 40px rgba(124,58,237,0.25)',
        'nav': '0 1px 0 0 rgba(11,31,58,.08)',
        'form': '0 2px 8px rgba(0,0,0,.05), 0 24px 64px rgba(11,31,58,.08)',
      },
      borderRadius: {
        '2xl': '1rem',
        '3xl': '1.5rem',
